...
public class PaymentService : BackgroundService
{
    ...
    private async Task<PaymentInformationDataTransferObject> ProcessPayment(PaymentInformationDataTransferObject paymentInformation,CancellationToken token)
    {
